...
void Object::setWaypoints()
{
	m_waypoints.push_back(glm::vec3(0.0f, 0.0f, 0.0f));
	m_waypoints.push_back(glm::vec3(0.75f, 0.75f, 0.0f));
	m_waypoints.push_back(glm::vec3(1.25f, 1.0f, 0.9f));
	m_waypoints.push_back(glm::vec3(-0.5f, 0.0f, 0.4f));
	m_waypoints.push_back(glm::vec3(0.5f, -0.6f, 0.8f));
}
